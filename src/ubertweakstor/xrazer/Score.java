...
public class Score{
	...
	/*
	 * Name: incrementBlockIDScore
	 * Description: Increment a certain BlockID's score
	 * Returns: None
	 * Parameters: int id: Block's ID, int data: Block's Data
	 * Requirements: None
	 */
	...
	/*
	 * Name: setBlockIDScore
	 * Description: Set a certain BlockID's score
	 * Returns: None
	 * Parameters: int id: Block's ID, int data: Block's Data, int score: Score to set
	 * Requirements: None
	 */
	...
	/*
	 * Name: getBlockIDScore
	 * Description: Gets a certain BlockID's score
	 * Returns: Integer
	 * Parameters: int id: Block's ID, int data: Block's Data
	 * Requirements: None
	 */
	...
	/*
	 * Name: getTotalScore
	 * Description: Gets the score of everything
	 * Returns: Integer
	 * Parameters: None
	 * Requirements: None
	 */
