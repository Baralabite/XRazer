...
public class BlockLogger {
	...
	/*
	 * Name: incrementBlockScore
	 * Description: Increments the numbers of blocks mined in the subsiquent catagories
	 * Returns: None
	 * Parameters: int id: Block ID, int data: Block data, Player player: Which player's 
	 *             profile to update
	 * Requirements: None
	 */
	...
	/*
	 * Name: getPossibleXrayers 
	 * Description: Returns List of all the players suspected of xraying since last check.
	 * Returns: List<Player>
	 * Parameters: None
	 * Requirements: None
	 */
	...
	public List<Player> getPossibleXrayers(){
	    ...
	    while (it.hasNext()) {
	        ...
	        if (score.getTotalScore() >= parent.getConfig().getInt("XRayThreshold") && !(parent.isPlayerWhitelisted(((Player) pairs.getKey()).getName()))){
	...
	public void clearScores(){
	    ...
	    while (it.hasNext()) {
	        Map.Entry pairs = (Map.Entry)it.next();
	        scores.remove((Player) pairs.getKey());
	    }
	}
